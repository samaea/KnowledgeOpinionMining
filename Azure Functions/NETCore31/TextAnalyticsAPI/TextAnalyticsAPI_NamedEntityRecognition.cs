...
namespace TextAnalyticsAPI_NamedEntityRecognition
{
        ...
        public static class ProductCategory
    {
        ...
        public static async Task<IActionResult> Run(
            ...
            ILogger log)
        {
            log.LogInformation("TextAnalyticsAPI_NamedEntityRecognition function: C# HTTP trigger function processed a request.");
